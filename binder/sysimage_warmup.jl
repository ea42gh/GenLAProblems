...
la.ge_bundle([1 0; 0 1], output_dir=warmup_dir)
la.eig_bundle([1 0; 0 1], output_dir=warmup_dir)
la.svd_bundle([2 0; 0 1], output_dir=warmup_dir)
la.qr_bundle([1 0; 0 1], output_dir=warmup_dir)
la.qr_figure([1 0; 0 1], output_dir=warmup_dir)
